...
readonly rossDIR=device/hardkernel/odroidc5
readonly TOOLS_DIR="$NEWTONDIR"/tools
readonly KEY_DIR="$rossDIR"/recovery/releasetools/keys
readonly DEVICE_DIR="$rossDIR"/upgrade
readonly UBOOT_DIR="$rossDIR"/prebuilt/bootloader
readonly UBOOT_DIR_OUT="out/target/product/ross"
